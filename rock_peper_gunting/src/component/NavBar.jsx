	...
	return (
		<nav className="fixed top-0 left-0 w-full z-50 navbar-bg shadow-lg flex flex-col px-8 h-24 pb-2">
		       ...
		       <div className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-wide select-none neon-title fade-in float">
			       Clash of Hands
			       <span className="emoji-bounce" role="img" aria-label="hands"> ✊</span>
			       <span className="emoji-bounce" style={{animationDelay: '0.15s'}} role="img" aria-label="hands"> 🖐</span>
			       <span className="emoji-bounce" style={{animationDelay: '0.3s'}} role="img" aria-label="hands"> ✌️</span>
		       </div>
			       <button 
