...
const CardRoom = ({ room }) => {
	...
	return (
		<div className="rounded-xl border border-[#1fa9d6] bg-[rgba(16,18,26,0.8)] p-4 text-white">
			<div className="flex justify-between items-center">
				<div>
					<h3 className="font-bold text-lg">Room {room.room_code}</h3>
					<p className="text-sm text-gray-400">{room.players ? room.players.length : 0}/2 Players</p>
				</div>
				<button
					onClick={handleJoinRoom}
					className="bg-[#1fa9d6] hover:bg-[#1fa9d6]/80 text-white font-bold py-2 px-4 rounded-lg transition disabled:bg-gray-500"
